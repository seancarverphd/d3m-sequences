...
\abstract{Do performers who submit \emph{diverse} collections of
  ...
  is: \emph{yes, there exists a measurable (i.e.\ significant)
    improvement in best score with increasing diversity, but the
    effect-size is small enough that it may not be of any consequence
    for making recommendations to performers.}}
